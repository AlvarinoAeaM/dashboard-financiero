...
*Vista general con KPIs y gráficos principales*
...
![Trends Analysis](screenshots/charts.png)
*Gráficos de series temporales y distribuciones*
...
git init
git add .
git commit -m "Initial commit - Dashboard Financiero"
git remote add origin https://github.com/AlvarinoAeaM/dashboard-financiero-aums.git
git push -u origin main
```

3. **Crear nueva app en Streamlit Cloud**
...
4. **Configurar secrets** (si es necesario)
   ...
   - Agregar credenciales o API keys

### URL de la App Desplegada
🔗 [https://alvarinoaeam-dashboard-financiero-aums.streamlit.app](https://alvarinoaeam-dashboard-financiero-aums.streamlit.app)
